...
import { fetchStart, fetchSuccess, likeVideo, unlikeVideo, dislikeVideo, undislikeVideo } from "../redux/VideoSlice";
    ...
    <Container>
      <Content>
        ...
        <Channel>
          ...
          <Subscribe onClick={handleSubscribe}>{currentUser?.subscribedChannels?.includes(channel._id) ? <p>SUBSCRIBED</p> : <p>SUBSCRIBE</p>}</Subscribe>
        </Channel>
        <Hr />
        <Comments/>
      </Content>
